...
import {Directive, DecoratorDirective} from '../../../src/lib/annotations';
import {DirectiveClass} from '../../../src/lib/compiler/directive_class';
import {SelectorConfig} from '../../../src/lib/compiler/selector_config';
...
describe('Selector', () => {
  ...
  beforeEach(function() {
    ...
    inject(Selector, SelectorConfig, (_selector, _config)=>{
      selector = _selector;
      config = _config;
      selector.addDirectives(createDirectives());
    });
  });
  ...
  describe('matchElement', () => {
    ...
    describe('match bindings', function() {
      ...
      it('should save all attributes except for bindings into attrs.init', () => {
        expect(selector.matchElement(e('<b test="a" bind-b="c" d="{{e}}" on-f="g"></b>')).attrs.init)
          .toEqual({'test': 'a'});
